...
<body class="">
	<form class="form-signin">
		<div class="text-center mb-4">
			...
			<p>Antar Jemput Putra/Putri Kesayangan Anda Tanpa Khawatir.</p>
		</div>

    <div class="form-label-group">
			<input type="text" id="inputText" class="form-control" placeholder="Nama Orang Tua" required autofocus>
			<label for="inputNamaOrangTua">Nama Orang Tua</label>
		</div>

    <div class="form-label-group">
			<input type="number" id="inputText" class="form-control" placeholder="Nomor Telepon" required autofocus>
